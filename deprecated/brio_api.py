"""
Brio API (brio_api.py)

Exposes Brio Core logic via REST API.
Includes:
...
from brio_models import ChatRequest, ChatResponse, FeedbackRequest
from brio_security import InputSanitizer

app = FastAPI(title="Brio API", version="1.0.0")
