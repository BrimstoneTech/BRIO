...
class BrioHooks:
    ...
    def start(self):
        ...
        try:
            ...
            print(f"[Hooks] Failed to register global hotkeys: {e}")
            print("[Hooks] This usually requires administrator privileges.")
            print("[Hooks] Brio will continue without keyboard shortcuts.")
